...
const Experience = () => {
  const experiences = [
    ...
    // },
    {
      ...
      location: "Nagpur, MH",
      description:
        "Working on building dynamic and responsive web applications using React.js, focusing on component-based architecture and state management.Integrating RESTful APIs and optimizing performance for enhanced user experience.",
      highlights: [
    ...
    },
    {
      ...
      location: "Bhopal, MP",
      description:
        "Completed an intensive training program focused on full stack web development using the MERN stack.",
      highlights: [
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-[#b3b3b3] max-w-2xl mx-auto">
            A chronological look at my professional journey and the technical
            expertise I've gained along the way.
          </p>
        </div>
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            {skillCategories.map((category, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="bg-[#1a1a1a] p-6 rounded-2xl border border-[#2d2d2d]"
                >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {category.skills.map((skill, sIdx) => (
                      <span
                        key={sIdx}
                        className="px-3 py-1 bg-[#2d2d2d] text-[#b3b3b3] text-sm rounded-md border border-[#3d3d3d]"
                      >
                        {skill}
                      </span>
                    ))}
            ...
            <div className="bg-linear-to-br from-[#ffa116] to-[#ffb800] p-6 rounded-2xl text-[#0a0a0a]">
              ...
              <p className="text-sm mb-4 font-medium opacity-90">
                Download my full resume for offline viewing.
              </p>

              <a
                href="/resume/resumenew.pdf"
                download
                className="w-full bg-[#0a0a0a] text-white py-3 rounded-xl font-bold hover:bg-black transition-colors flex items-center justify-center gap-2"
              >
                Download Resume
                <Download size={16} />
              </a>
                    ...
                    <div className="bg-[#1a1a1a] border border-[#2d2d2d] p-6 rounded-2xl grow group-hover:border-[#ffa116]/50 transition-all">
                      ...
                      <div className="grid sm:grid-cols-1 gap-3">
                        {exp.highlights.map((highlight, hIdx) => (
                          <div
                            key={hIdx}
                            className="flex items-start gap-3 text-sm text-[#eff1f6]"
                          >
                            <CheckCircle2
                              size={16}
                              className="text-[#ffa116] mt-0.5 shrink-0"
                            />
                            <span>{highlight}</span>
                          </div>
                        ))}
            ...
            {[
              {
                ...
                desc: "Custom, responsive websites built with modern frameworks for optimal speed and SEO.",
                icon: Globe,
              },
              {
                title: "API Integration",
                desc: "Seamlessly connecting your frontend with robust backends and 3rd party services.",
                icon: Layers,
              },
              {
                title: "Performance Tuning",
                desc: "Analyzing and optimizing application bottlenecks for lightning-fast user experiences.",
                icon: Zap,
              },
            ].map((service, i) => (
              <div
                key={i}
                className="bg-[#1a1a1a] p-8 rounded-2xl border border-[#2d2d2d] text-center hover:-translate-y-2 transition-transform"
              >
